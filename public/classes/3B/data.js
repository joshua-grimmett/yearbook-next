module.exports = {
  title: '3B',
  teachers: [
    {name: 'Megan Bullot', image: '/staff/Bullot, Megan.jpg'},
    {name: 'Michele Sara', image: '/staff/Sara, Michele.jpg'}
  ],
  poster: '/classes/3B/poster.png',
  pageNumbers: [0,0],
  colours: 'yr3',
  classPhotos: [
    {image: '/classes/3B/images/img3.jpg', caption: 'Mia, Willow and Breanna'},
    ...
    {image: '/classes/3B/images/img8.jpg', caption: 'Keny, Nejiahl, Taylor and Oliver'},
  ...
  tableText: [
    {name: 'Lennox Amotawa', job: 'learning in class and making new friends.'},
    {name: 'Michael Bloemers', job: 'playing with my friends. '},
    {name: 'Keny Chen', job: 'getting to know people and learning new things. '},
    {name: 'Axis Chesworth', job: 'learning together with 3B.'},
    {name: 'Noah Colli', job: 'making new friendships.'},
    {name: 'Oliver Evans', job: 'meeting my teacher and learning new things. '},
    {name: 'Mia Harcombe', job: 'spending time with friends and helping Mrs Bullot. '},
    {name: 'Maddox Hicks', job: 'making new friendships.'},
    {name: 'Breanna Holm', job: 'getting my Diamond badge.'},
    ...
    {name: 'Kaysha Mustafa', job: 'playing team sports with my friends.'},
    {name: 'Isobel Rhone', job: 'learning new things. '},
    {name: 'Indiana Rose', job: 'making friends and getting my Diamond promotion. '},
