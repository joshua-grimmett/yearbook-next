...
const LongTableTextCard = ({ text, question, style }: { text: any, question: string, style: object }) => {
  return (
    <div className="tableText__card tableText__card--long">
      <span className="question">{question}</span>
      <div className="table" style={style}>
        {text.map((row: any, i: number) => (
          <div className="table__row" key={i}>
